...
const struct fieldinfo fieldinfos[]= {
  ...
  { FIELD("Filename"),         f_filecharf,       w_filecharf,      ARCHIVEFOFF(name)        },
  { FIELD("Size"),             f_filecharf,       w_filecharf,      ARCHIVEFOFF(size)        },
  { FIELD("MD5sum"),           f_filecharf,       w_filecharf,      ARCHIVEFOFF(md5sum)      },
  { FIELD("MSDOS-Filename"),   f_filecharf,       w_filecharf,      ARCHIVEFOFF(msdosname)   },
